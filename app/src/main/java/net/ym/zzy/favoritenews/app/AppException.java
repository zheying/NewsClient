package net.ym.zzy.favoritenews.app;
...
import net.ym.zzy.favoritenews.common.UIHelper;
...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	public void uncaughtException(Thread thread, Throwable ex) {
        ...
        Toast.makeText(AppApplication.getApp(), "uncaughtException", Toast.LENGTH_SHORT).show();
