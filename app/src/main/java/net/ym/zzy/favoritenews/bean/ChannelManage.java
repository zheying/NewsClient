package net.ym.zzy.favoritenews.bean;
...
import net.ym.zzy.favoritenews.dao.ChannelDao;
import net.ym.zzy.favoritenews.db.SQLHelper;
...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(5, "国际", 5, 1));
		defaultUserChannels.add(new ChannelItem(6, "娱乐", 6, 1));
		defaultUserChannels.add(new ChannelItem(7, "环保", 7, 1));
		defaultOtherChannels.add(new ChannelItem(8,"社会", 1, 0));
		defaultOtherChannels.add(new ChannelItem(9, "科技", 2, 0));
		defaultOtherChannels.add(new ChannelItem(10, "财经", 3, 0));
