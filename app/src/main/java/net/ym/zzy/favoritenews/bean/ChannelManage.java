...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(2, "国内", 2, 1));
//		defaultUserChannels.add(new ChannelItem(3, "杭州", 3, 1));
		...
		defaultUserChannels.add(new ChannelItem(6, "环保", 6, 1));
		defaultOtherChannels.add(new ChannelItem(7,"社会", 1, 0));
		defaultOtherChannels.add(new ChannelItem(8, "科技", 2, 0));
		defaultOtherChannels.add(new ChannelItem(9, "财经", 3, 0));
