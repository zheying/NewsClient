...
package com.sina.android.weibo.sdk.widget;
...
import com.sina.android.weibo.sdk.R;
...
import com.sina.android.weibo.sdk.openapi.LogoutAPI;
...
public class LoginoutButton extends Button implements OnClickListener {
	 ...
	 * <p>
	 * 重要：使用该控件的 Activity 必须重写 {@link android.app.Activity#onActivityResult(int, int, android.content.Intent)}，
	 ...
	 * }
	 * </pre>
	 * @param requestCode 请查看 {@link android.app.Activity#onActivityResult(int, int, android.content.Intent)}
	 * @param resultCode  请查看 {@link android.app.Activity#onActivityResult(int, int, android.content.Intent)}
	 * @param data        请查看 {@link android.app.Activity#onActivityResult(int, int, android.content.Intent)}
	 */
	...
	/**
	 * 调用 {@link LogoutAPI#logout(com.sina.weibo.sdk.net.RequestListener)} 来注销。
	 */
	private void logout() {
		if (mAccessToken != null && mAccessToken.isSessionValid()) {
