...
package com.sina.android.weibo.sdk.openapi;
...
public class CommentsAPI extends AbsOpenAPI {
    ...
    /**
     * @see #show(long, long, long, int, int, int, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #byME(long, long, int, int, int, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #toME(long, long, int, int, int, int, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #timeline(long, long, int, int, boolean, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #mentions(long, long, int, int, int, int, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #showBatch(long[], com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #create(String, long, boolean, com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #destroyBatch(long[], com.sina.weibo.sdk.net.RequestListener)
     */
    ...
    /**
     * @see #reply(long, long, String, boolean, boolean, com.sina.weibo.sdk.net.RequestListener)
     */
